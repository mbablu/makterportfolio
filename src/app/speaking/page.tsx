  ...
  return (
    ...
    <div>
      <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
        Open to &apos;full-time or contract&lsquo; roles as a UX Designer, Product Designer, or UX Strategist — hybrid in Toronto or fully remote. I bring both hands-on design skills and strategic leadership to projects that aim to improve lives, streamline processes, and deliver with purpose.
      </p>
      <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
